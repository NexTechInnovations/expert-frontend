const TransactionsEmptyState = () => {
    return (
        <div className="flex flex-col items-center justify-center text-center py-16">
            ...
            <h2 className="text-xl font-bold text-gray-800 mt-6">Your transactions list will be here.</h2>
            <p className="text-sm text-gray-500 mt-2">You can add your first transaction by clicking "Claim Transaction".</p>
        </div>
    );
};
