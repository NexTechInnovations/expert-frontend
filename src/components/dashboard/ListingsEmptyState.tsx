const ListingsEmptyState = () => {
  const SvgIcon = () => (
    <div className="w-40 h-40 relative">
        ...
        >
            <circle cx="120" cy="120" r="120" fill="rgba(227,227,227,0.5)" />
        </svg>
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16">
      <SvgIcon />
      <h2 className="text-xl font-bold text-gray-800 mt-6">Your listings live here</h2>
      <p className="text-sm text-gray-500 mt-2">
        Publish your properties on Property Finder and other portals.
      </p>
    </div>
  );
};
